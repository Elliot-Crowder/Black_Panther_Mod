package net.elliot.blackpanthermod.client;
...
public class ClientOperations {
    ...
    public static void adjustPlayerMovement(OptionalDouble x, OptionalDouble y, OptionalDouble z, UpdateClientVelocityPacket.Operation operation){
